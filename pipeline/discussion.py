    ...
    for i, admission in enumerate(admissions):
        ...
        for window_idx, window in enumerate(windowed_ehr_list):
            ...
            for round in range(num_rounds):
                ...
                if end_condition == "consensus":
                ...
                elif end_condition == "leader": # based on leader decision
                    ...
                    if response_text is None or response_text.strip() == "":
                        ...
                        if not bool_decision_made and len(reasoning) > 0:
                            ...
                            predicted_procedures_icd9.extend(formatted_leader_response["Decided ICD9"])
                            predicted_procedures_text.extend(formatted_leader_response["Decided Text"])
                            num_rounds_per_window.append(round + 1)  # save the number of rounds for this window 
                            break # move to next window
